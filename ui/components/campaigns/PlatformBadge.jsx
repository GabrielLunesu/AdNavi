export default function PlatformBadge({ platform }) {
  const map = {
    ...
    'meta': { bg:'bg-sky-500/15', color:'text-sky-300', text:'M' },
    'google': { bg:'bg-amber-500/15', color:'text-amber-300', text:'G' },
    'tiktok': { bg:'bg-fuchsia-500/15', color:'text-fuchsia-300', text:'T' },
    'other': { bg:'bg-white/10', color:'text-slate-300', text:'O' },
  };
