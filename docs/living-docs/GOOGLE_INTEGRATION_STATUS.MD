...
- Performance Max support:
  - Asset groups are mapped to AdNavi’s `adset` level; asset group assets are mapped to `creative` level. This makes the UI and QA reflect what you see in Google Ads.
